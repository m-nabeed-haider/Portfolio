// Small brand icons as inline SVG. lucide-react no longer ships brand marks
// (Github/Linkedin), so these are hand-rolled to the same 24x24 stroke grid
